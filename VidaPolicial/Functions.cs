            ...
            Global.Situacoes = new List<Situacao>()
            {
                new Situacao()
                {
                    ...
                    PosicoesPoliciais = new List<Situacao.Posicao>()
                    {
                        ...
                        new Situacao.Posicao()
                        {
                            ...
                            Rotation = new Rotation(0f, 0.03125f, 1.609375f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-29.986813f, -1502.9275f, 30.206543f),
                            Rotation = new Rotation(0.03125f, 0f, 0.90625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(63.6f, -1387.4901f, 28.926025f),
                            Rotation = new Rotation(-0.015625f, 0f, 0.046875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(26.10989f, -1357.2924f, 28.808105f),
                            Rotation = new Rotation(0f, 0.046875f, 1.546875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-58.074726f, -1357.3055f, 28.858643f),
                            Rotation = new Rotation(0f, 0.046875f, 1.515625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-146.47913f, -1373.3539f, 28.993408f),
                            Rotation = new Rotation(0f, 0.0625f, 2.125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-201.87692f, -1407.0198f, 30.745728f),
                            Rotation = new Rotation(0f, 0.046875f, 2.0625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-176.14944f, -1512.8044f, 32.835205f),
                            Rotation = new Rotation(-0.109375f, 0f, -0.703125f),
                        },
                    },
                },
                new Situacao()
                {
                    ...
                    PosicaoFugitivo = new Situacao.Posicao()
                    {
                        ...
                        Rotation = new Rotation(0.015625f, 0f, 1.21875f),
                    },
                    PosicoesPoliciais = new List<Situacao.Posicao>()
                    {
                        new Situacao.Posicao()
                        {
                            Position = new Position(173.81538f, 132.56703f, 97.67322f),
                            Rotation = new Rotation(-0.21875f, 0.046875f, 2.765625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(188.91429f, 101.670334f, 92.028564f),
                            Rotation = new Rotation(-0.015625f, -0.1875f, 1.265625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(233.35385f, -46.443954f, 69.09595f),
                            Rotation = new Rotation(-0.03125f, 0f, 2.734375f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(342.58023f, 31.793407f, 88.01831f),
                            Rotation = new Rotation(0.125f, -0.15625f, 1.15625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(358.9978f, 110.69011f, 102.32385f),
                            Rotation = new Rotation(0.046875f, 0.046875f, -0.328125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(293.1165f, 75.0989f, 93.93262f),
                            Rotation = new Rotation(0f, 0f, 2.796875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(537.9824f, 87.797806f, 95.76929f),
                            Rotation = new Rotation(0.03125f, 0.046875f, 1.203125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(462.01318f, 222.96263f, 102.69446f),
                            Rotation = new Rotation(0f, 0f, 1.265625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(476.87473f, 81.125275f, 96.79712f),
                            Rotation = new Rotation(-0.0625f, 0f, -1.90625f),
                        },
                    },
                },
                new Situacao()
                {
                    ...
                    PosicaoFugitivo = new Situacao.Posicao()
                    {
                        Position =  new Position(-656.7033f, -275.789f, 35.278442f),
                        Rotation = new Rotation(0.015625f, 0f, 0.515625f),
                    },
                    PosicoesPoliciais = new List<Situacao.Posicao>()
                    {
                        new Situacao.Posicao()
                        {
                            Position = new Position(-601.5692f, -359.5121f, 34.469604f),
                            Rotation = new Rotation(0f, 0f, 1.578125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-658.0747f, -437.76263f, 34.33484f),
                            Rotation = new Rotation(-0.03125f, -0.015625f, -1.53125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-730.4308f, -371.74945f, 34.587524f),
                            Rotation = new Rotation(-0.046875f, 0.015625f, -0.453125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-824.7033f, -383.23517f, 38.07544f),
                            Rotation = new Rotation(0.09375f, 0.015625f, 1.140625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-932.54504f, -319.45056f, 38.648315f),
                            Rotation = new Rotation(-0.015625f, 0.046875f, -1.921875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-857.7099f, -259.76703f, 39.15381f),
                            Rotation = new Rotation(0.015625f, 0f, 2.703125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-610.2725f, -476.24176f, 34.2843f),
                            Rotation = new Rotation(0f, 0f, 1.625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-477.73187f, -340.41757f, 33.96411f),
                            Rotation = new Rotation(0f, 0f, 3f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-433.04175f, -404.43954f, 32.41394f),
                            Rotation = new Rotation(0f, 0.03125f, -0.125f),
                        },
                    }
                },
                new Situacao()
                {
                    ...
                    PosicaoFugitivo = new Situacao.Posicao()
                    {
                        ...
                        Rotation = new Rotation(0.015625f, 0.046875f, 0.28125f),
                    },
                    PosicoesPoliciais = new List<Situacao.Posicao>()
                    {
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1207.2131f, -1166.3605f, 7.206543f),
                            Rotation = new Rotation(0f, 0.0625f, 0.28125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1164.6725f, -1199.3011f, 3.432251f),
                            Rotation = new Rotation(0.09375f, 0f, 1.78125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1272.3956f, -1239.5472f, 3.769287f),
                            Rotation = new Rotation(0.015625f, 0.03125f, 0.390625f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1279.3583f, -1283.2616f, 3.4659424f),
                            Rotation = new Rotation(0f, 0.046875f, -1.171875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1195.2527f, -1369.9517f, 4.0893555f),
                            Rotation = new Rotation(0.046875f, 0.03125f, -1.109375f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1205.8418f, -1353.1252f, 3.9714355f),
                            Rotation = new Rotation(-0.015625f, 0.046875f, 2.046875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1080.3561f, -1282.0483f, 5.201416f),
                            Rotation = new Rotation(0f, 0.0625f, 2.078125f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1175.5648f, -1224.4088f, 6.397827f),
                            Rotation = new Rotation(0f, 0f, 1.921875f),
                        },
                        new Situacao.Posicao()
                        {
                            Position = new Position(-1071.9429f, -1015.0154f, 1.5787354f),
                            Rotation = new Rotation(0f, -0.0625f, 0.546875f),
                        },
                    }
                }
            };
